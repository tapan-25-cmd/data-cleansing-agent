...
export function AccuracyPage() {
  ...
  return <div className="results-page acc-page">
    ...
    <div className="acc-subnav"><button className="active">Accuracy</button><Link to={`/jobs/${jobId}/blind-test`}>Blind test</Link><Link to={`/jobs/${jobId}/sample-check`}>Sample check</Link></div>
